...
class UtmClientChart extends ChartWidget
{
    protected static ?string $heading = 'First-Touch: Источники регистраций (по клиенту)';
    protected int | string | array $columnSpan = 1; // Занимает половину ширины (1 из 2)
    ...
    protected function getData(): array
    {
        ...
        // Получаем все оплаченные сделки запуска
        ...
        // Группируем по UTM пользователя (First-Touch)
        $grouped = $deals->groupBy(function($deal) {
            return $deal->client?->utm_source ?: 'Прямой заход / Органика';
        ...
        return [
            'datasets' => [
                [
                    ...
                    'backgroundColor' => ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#64748b', '#ec4899'],
                    'borderWidth' => 0,
                ],
            ],
